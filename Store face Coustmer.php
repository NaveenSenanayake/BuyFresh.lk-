...
<form id="form1" name="form1" >
  <table width="200" border="0" align="center">
    <tbody>
      <tr>
	    <td><div class="pic"> <a href= "viweStoreCoustmer.php"><img src="Images/img1.jpg.jpg" width="235" height="225"></a>
         <p style="font-family: Segoe, 'Segoe UI', 'DejaVu Sans', 'Trebuchet MS', Verdana, sans-serif">Vegetable</p>
	    </div></td>
        <td><div class="pic"> <a href= "viweStoreLCoustmer.php"><img src="Images/img2.jpg" width="235" height="225"></a>
